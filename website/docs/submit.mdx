...
and session information like any browser does locally.
:::

## How To Specify The URL

You can provide the `url` in **2** different ways:
...
For example, if I want to use `C++ (Clang 10.0.0)` for `cpp` files in AtCoder, I would write
