...
:::tip
Visit the [**Debug**](/docs/debug) section to see more examples and to learn how to take full advantage of this feature.
:::

### `languages.<lang>.aliases: Object<OnlineJudgeName, string>`

Language "aliases" for each OnlineJudge. See [Language Aliases](/docs/language-aliases) for a list of aliases per Online Judge.
